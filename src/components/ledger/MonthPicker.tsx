...
type MonthPickerProps = {
    ...
    setStandardMonth: React.Dispatch<React.SetStateAction<number>>;
    standardYear: number;
    setStandardYear: React.Dispatch<React.SetStateAction<number>>;
}

export default function MonthPicker(props: MonthPickerProps){
    let {setIsMonthPicker, standardMonth, setStandardMonth, standardYear, setStandardYear} = props;
    ...
    return(
        <Wrapper>
            <TitleWrapper>
                <span>월 선택</span>
                <svg onClick={handleCloseBtnClick} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
