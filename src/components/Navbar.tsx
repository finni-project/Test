    ...
    return(
        <Wrapper>
            ...
            <NavLink to="/ledger" className={({isActive}) => (isActive? "banknote-link" : undefined)}>
                <IconWrapper>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        fill="#B7B7B7" stroke="#B7B7B7" strokeWidth="0.5"/>
                    </svg>
                    <span>용돈노트</span>
                </IconWrapper>
            </NavLink>
                    ...
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clipPath="url(#clip0_631_1244)">
                            ...
                            <g mask="url(#mask0_631_1244)">
                                <circle cx="12" cy="12" r="10.2" stroke="#B7B7B7" strokeWidth="2"/>
            ...
            <NavLink to="/economyClass" className={({isActive}) => (isActive? "school-link" : undefined)}>
                <IconWrapper>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fillRule="evenodd" clipRule="evenodd" d="M2 2C0.895431 2 0 2.89543 0 4V18C0 19.1046 0.89543 20 2 20H22C23.1046 20 24 19.1046 24 18V4C24 2.89543 23.1046 2 22 2H2ZM2.5 3.5C1.94772 3.5 1.5 3.94772 1.5 4.5V17.5C1.5 18.0523 1.94772 18.5 2.5 18.5H21.5C22.0523 18.5 22.5 18.0523 22.5 17.5V4.5C22.5 3.94772 22.0523 3.5 21.5 3.5H2.5Z" fill="#B7B7B7"/>
                ...
                <IconWrapper>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clipPath="url(#clip0_678_1237)">
                            <circle cx="12" cy="12" r="11.2" stroke="#B7B7B7" strokeWidth="1.6"/>
