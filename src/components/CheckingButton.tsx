...
export default function CheckingButton({id, text, active, handleButtonClick}: CheckingButtonProps){

    return(
        <>
            <Button id={id} data-disabled={false} onClick={handleButtonClick}>
                <span>{text}</span>
                <svg className={active? "checked" : undefined}
